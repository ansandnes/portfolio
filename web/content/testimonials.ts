...
/**
 * Testimonials. `content` strings are direct quotes — preserved verbatim,
 * including the authors' own typos. Do not copyedit them.
 */
export const testimonials: Testimonial[] = [
  {
    ...
    relation:
      "Evdoxia was the primary bioinformatician taking over the projects I worked on after I left the TIL group. We collaborated closely on several projects during my time there.",
    image: null,
...
From my perspective, Andreas stands out for his ability to bridge the gap between software engineering and biological research. His technical abilities, curiosity, and strong communication skills make him a valuable addition to any interdisciplinary team. I am confident he will bring the same level of dedication, innovation, and professionalism to any future role he undertakes.`,
  ...
  },
  {
    ...
    company: "TIL group, CCIT-DK (National Center for Cancer Immune Therapy)",
    relation:
      "Marco was the head of the immunology research group where I worked as a bioinformatician.",
    image: null,
...
I believe Andreas would be a strong asset to any software engineering position within biological research. He combines the technical foundation needed to tackle challenging data workflows with the adaptability to work effectively in diverse scientific environments.`,
    ...
    impact: [
      ...
      "Bridges software engineering and research",
    ],
  },
  {
    id: 3,
    ...
    company: "TIL group, CCIT-DK (National Center for Cancer Immune Therapy)",
    relation:
      "I reported to Arianna on single-cell data analysis and other bioinformatics projects during my time at the TIL group.",
    image: null,
...
I am confident Andreas will excel in any goal he sets for himself, and I recommend him without hesitation for this position.`,
  ...
  },
  {
    ...
    relation:
      "Johannes was the leader I reported to in all projects, and he was the primary supervisor of my master’s thesis.",
    image: null,
  ...
  },
  {
    ...
    company: "Amgen Research Copenhagen",
    relation:
      "Martin is a biologist analyzing data from Illuminasequencing. I collaborated with him on multipledashboard projects facilitating his analysis.",
    image: null,
  ...
  },
  {
    ...
    company: "Amgen Research Copenhagen",
    relation:
      "Daniel is a biochemist and data scientist, he was the secondary supervisor of my master’s thesis.",
    image: null,
...
/** Testimonials shown on the home page, in this order. */
export const FEATURED_TESTIMONIAL_IDS: ReadonlyArray<number> = [5, 6];

export const featuredTestimonials: Testimonial[] = FEATURED_TESTIMONIAL_IDS.map((id) => {
  const match = testimonials.find((t) => t.id === id);
  if (!match) throw new Error(`Featured testimonial id ${id} not found`);
  return match;
});
