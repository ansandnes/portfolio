/**
 * Curated resume shown on /resume. This is the on-page, English rendering of the
 * downloadable CV (web/public/assets/cv_andreas_sandnes.pdf, currently Norwegian
 * — TODO: regenerate an English PDF).
 *
...
export const resume: ResumeData = {
  ...
  skills: [
    {
      category: "General",
      items: ["Data communication", "Git", "Programming", "SQL", "AI agents"],
    },
    {
      category: "Cloud / HPC",
      items: ["High-Performance Computing (Computerome)"],
    },
    {
      category: "Bioinformatics",
      items: ["scRNA-seq (10x Genomics, Seurat)", "DGE (DESeq2, EdgeR)"],
    },
  ],
  ...
  pdfPath: "/assets/cv_andreas_sandnes.pdf",
};
